...
public class CartResources {
	...
	@RequestMapping(value = "/create/{productId}", method = RequestMethod.PUT)
	@ResponseStatus(value = HttpStatus.NO_CONTENT)
	public void storeItem (@PathVariable(value = "productId") int productId, @AuthenticationPrincipal User activeUser){
		Customer customer = customerServie.getCustomerByUsername(activeUser.getUsername());
	...
	@ResponseStatus(value = HttpStatus.BAD_REQUEST, reason = "Illegal request, please verify our payload.")
